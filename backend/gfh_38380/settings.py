"""
Django settings for gfh_38380 project.
...
WSGI_APPLICATION = 'gfh_38380.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gfh_38380 API",
    "DESCRIPTION": "API documentation for gfh_38380 App",
    "VERSION": "v1",
}
